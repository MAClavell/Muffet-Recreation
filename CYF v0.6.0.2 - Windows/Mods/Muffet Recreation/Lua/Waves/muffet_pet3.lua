...
for i=1, 21 do
  table.insert(spiderManipulatableObj, psbul.SpiderManipulatable.new( { sprite="purplesoul/spiderbullet", spriteInvis="purplesoul/spiderbulletinvis", y=r1, side=false, speed=5, time=ourtime+spawntime, spawned=false }))
  table.insert(spiderManipulatableObj, psbul.SpiderManipulatable.new( { sprite="purplesoul/spiderbullet", spriteInvis="purplesoul/spiderbulletinvis", y=r2, side=false, speed=5, time=ourtime+spawntime, spawned=false }))
  if stage==1 then
    stage=2
    r1=webs[1].absy
    r2=webs[3].absy
