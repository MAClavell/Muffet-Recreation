...
table.insert(croissantObj, psbul.Croissant.new( { sprite="purplesoul/croissantr", y=webs[1].y, side=true, time=ourtime+1.5, spawned=false }))
...
table.insert(croissantObj, psbul.Croissant.new( { sprite="purplesoul/croissantr", y=webs[1].y, side=false, time=ourtime+3, spawned=false }))
...
--Set 3
table.insert(croissantObj, psbul.Croissant.new( { sprite="purplesoul/croissantr", y=webs[3].y, side=true, time=ourtime+4, spawned=false }))
table.insert(croissantObj, psbul.Croissant.new( { sprite="purplesoul/croissantr", y=webs[1].y, side=true, time=ourtime+4.5, spawned=false }))
table.insert(croissantObj, psbul.Croissant.new( { sprite="purplesoul/croissantr", y=webs[2].y, side=true, time=ourtime+5, spawned=false }))
